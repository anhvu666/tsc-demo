        ...
        const list = `
          ...
          product.model
            ...
            <td>
              <div>
                <a 
                href="/tscshop/pages/admin/edit-form/amplifier-edit.html?id=${
                  product.id
                }" 
      ...
      button.addEventListener("click", async function () {
        ...
        try {
          const response = await fetch(
            `https://cors-anywhere.herokuapp.com/${API_URL}/ampli/delete/${productId}`,
            {
              method: "DELETE",
              headers: {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form) {
    form.addEventListener("submit", async function (event) {
      ...
      try {
        const response = await fetch(
          `https://cors-anywhere.herokuapp.com/${API_URL}/ampli/create`,
          {
            method: "POST",
            headers: {
              Authorization: basicAuth,
